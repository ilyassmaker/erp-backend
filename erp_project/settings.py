...
SECRET_KEY = "django-insecure-c7g@d^@yy_xjrt+e_+lcq#=#ca8g2)#jl2-9&4-29&p^qyadzm"
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # ligne à ajouter
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://localhost:5346",   # ← ajoute ce port
